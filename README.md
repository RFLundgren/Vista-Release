...
Download the latest portable executable from the [Releases page](https://github.com/RFLundgren/Vista-Release/releases/latest):

- **x64**: for most Windows PCs using Intel or AMD processors.
- **ARM64**: for Windows PCs using an ARM processor, including supported Snapdragon devices.

If you are unsure, open **Settings > System > About** in Windows and check **System type**.

## Using Vista Capture

1. Download the executable that matches your computer.
2. Place it in any folder where you want to keep the application.
3. Run the executable. No installer or administrator access is normally required.
...
To update, quit Vista Capture from its notification-area icon, replace the old executable with the newer build, and start it again.

## Windows Security Notice

The portable executables are currently unsigned. Windows SmartScreen may therefore display an **Unknown publisher** warning. Download Vista Capture only from this repository's official Releases page.
